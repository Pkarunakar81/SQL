...
*/
DECLARE @SQL_QUERY NVARCHAR(max),@Job_Name varchar(50)='DSS_COL',@date date=null--'2022-02-09'
set @SQL_QUERY='



IF OBJECT_ID(''tempdb..#TMP_SESSIONS_KAR'') IS NOT NULL                                          
DROP TABLE #TMP_SESSIONS_KAR
...
BEGIN;
	...
	BEGIN;
		...
		CREATE STATISTICS s_session_id ON #TMP_SESSIONS_KAR (session_id)
		WITH SAMPLE 0 ROWS, NORECOMPUTE;
		CREATE STATISTICS s_request_id ON #TMP_SESSIONS_KAR (request_id)
		WITH SAMPLE 0 ROWS, NORECOMPUTE;
		CREATE STATISTICS s_transaction_id ON #TMP_SESSIONS_KAR (transaction_id)
		WITH SAMPLE 0 ROWS, NORECOMPUTE;
		CREATE STATISTICS s_session_number ON #TMP_SESSIONS_KAR (session_number)
		WITH SAMPLE 0 ROWS, NORECOMPUTE;
		CREATE STATISTICS s_status ON #TMP_SESSIONS_KAR (status)
		WITH SAMPLE 0 ROWS, NORECOMPUTE;
		CREATE STATISTICS s_start_time ON #TMP_SESSIONS_KAR (start_time)
		WITH SAMPLE 0 ROWS, NORECOMPUTE;
		CREATE STATISTICS s_last_request_start_time ON #TMP_SESSIONS_KAR (last_request_start_time)
		WITH SAMPLE 0 ROWS, NORECOMPUTE;
		CREATE STATISTICS s_recursion ON #TMP_SESSIONS_KAR (recursion)
		WITH SAMPLE 0 ROWS, NORECOMPUTE;
		...
		BEGIN;	
			...
			INNER HASH JOIN #TMP_SESSIONS_KAR AS s ON
	...
	--EXEC sp_executesql @sql_n
	-----------------------------disables above statement to get the custom output
end;
...
SELECT a.JOB_NAME,PROC_NAME
,ROW_NUMBER() OVER(ORDER BY GETDATE())STEPNO
,concat(STEP_ID,''-'',STEP_SUBID,''-'',a.STEPNAME)STEPNAME
,cast(b.CompleatedTime as smalldatetime)CompleatedTime
into ##tmp_kar_job_status
FROM (select ''DSS_COL''JOB_NAME,''udp_daily_disbursements_DP''PROC_NAME,''1''STEP_ID ,''1''STEP_SUBID ,''t_disbursements-Update-Branch_USR_State''STEPNAME
UNION ALL select ''DSS_COL'',''udp_daily_disbursements_DP'',''1'' ,''2'' ,''t_disbursements-Update-PM_AM_DM''
UNION ALL select ''DSS_COL'',''udp_daily_disbursements_DP'',''1'' ,''3'' ,''t_disbursements_summary_Start''
UNION ALL select ''DSS_COL'',''udp_daily_disbursements_DP'',''1'' ,''4'' ,''t_disbursements_summary_Finished''
UNION ALL select ''DSS_COL'',''udp_daily_disbursements_DP'',''1'' ,''5'' ,''Disb Data Summary Compleated''
UNION ALL select ''DSS_COL'',''udp_daily_OD_Anytime'',''2'' ,''1'' ,''Live_DDvsC-t_loan_Daily_ODs_BEOD_or_AEOD created''
UNION ALL select ''DSS_COL'',''udp_daily_OD_Anytime'',''2'' ,''2'' ,''Daily OD Compleated''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''1'' ,''Live_DDvsC-t_collections0 Creations Started''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''2'' ,''Live_DDvsC-t_collections0 table Created''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''3'' ,''Live_DDvsC-CalculationsUpdated''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''4'' ,''Live_DDvsC-DueDate for Apr17 updated''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''5'' ,''Live_DDvsC-##TempTables_TAC Created''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''6'' ,''Live_DDvsC-##TempTables_TGM Created''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''7'' ,''Live_DDvsC-##TempTables_TC Created''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''8'' ,''Live_DDvsC-##TempTables Created''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''9'' ,''Live_DDvsC-Update-Product_ClientID''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''10'' ,''Live_DDvsC-Update-ClientBranchID_ClientName''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''11'' ,''Live_DDvsC-Update-Center_Group''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''12'' ,''Live_DDvsC-Update-Phones''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''13'' ,''Live_DDvsC-Update-Branch_USR_State''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''14'' ,''Live_DDvsC-Update-Region_Branch''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''15'' ,''Live_DDvsC-Update-PM_AM_DM''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''16'' ,''Live_DDvsC-Update-PrductDetails''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''17'' ,''Live_DDvsC-Update-Rligin,Cast,CRS&LO''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''18'' ,''Live_DDvsC-t_rpt_collections_summary table Creation Started''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''19'' ,''Live_DDvsC-t_rpt_collections_summary table Created''
UNION ALL select ''DSS_COL'',''udp_InstDues_vs_Coll'',''3'',''20'' ,''InstDues Vs Coll Compleated''
UNION ALL select ''DSS_COL'',''SP_OD_BRNET'',''4'',''1'' ,''OD Table Strated''
UNION ALL select ''DSS_COL'',''SP_OD_BRNET'',''4'',''2'' ,''OD Table Compleated''
--UNION ALL select ''DSS_COL'',''r_UJJ_Daily_IOD_MIS'',''5'' ,''1'' ,''Prev_IOD_Run_Already ''
--UNION ALL select ''DSS_COL'',''r_UJJ_Daily_IOD_MIS'',''5'' ,''2'' ,''IOD_Prev_completed''
UNION ALL select ''DSS_COL'',''r_UJJ_Daily_IOD_MIS'',''5'' ,''1'' ,''Daily_IOD_Completed''
UNION ALL select ''DSS_COL'',''USP_RPT_Glow_Daily_Rejects'',''6'',''1'',''Glow_Rejects_Daily_Completed'')A
left JOIN (select StepName,max(CompleatedTime)CompleatedTime from [10.10.101.38].[MIS_DB].[DBO].SERIES WHERE CAST(CompleatedTime AS DATE)=ISNULL(@date,CAST(GETDATE() AS DATE)) 
group by StepName
)B ON A.StepName=B.STEPNAME
ORDER BY b.CompleatedTime desC

--select JOB_NAME,PROC_NAME,STEPNO,STEPNAME,StartTime,EndTime
...
select JOB_NAME,PROC_NAME,STEPNO,STEPNAME,isnull(StartTime,EndTime)StartTime,EndTime
...
from(select JOB_NAME,PROC_NAME,STEPNO,STEPNAME,lag(CompleatedTime, 1,CompleatedTime) 
OVER(ORDER BY CompleatedTime ASC) AS StartTime,CompleatedTime EndTime 
from ##tmp_kar_job_status
)a order by a.STEPNO asc


SELECT a.JOB_NAME,a.PROC_NAME,a.STEPNAME,isnull(a.StartTime,(select max(endtime) from ##tmp_kar_job_status_F where PROC_NAME=B.PROC_NAME))StartTime
,a.EndTime,a.Duration
,CASE WHEN [dd hh:mm:ss.mss] IS NOT NULL THEN STUFF(CONVERT(VARCHAR(20),GETDATE()-(select max(endtime) from ##tmp_kar_job_status1_F),114),1,2
,DATEDIFF(hh,0,GETDATE()-(select max(endtime) from ##tmp_kar_job_status1_F))) END Step_Duration   
,[dd hh:mm:ss.mss] Procedure_Duration
,session_id,blocking_session_id,status,sql_text,procedurename
--,Machine,database_name,login_name,CPU,tempdb_current
--,used_memory,wait_info,login_time,start_time
--,collection_time,reads,physical_reads,writes,tempdb_allocations

,RUN_DATE JOB_RUN_DATE,C.Duration JOB_Duration,JOB_STEP 
FROM ##tmp_kar_job_status_F A
LEFT JOIN (
SELECT * FROM ##tmp_kar_job_status_F A
INNER JOIN (
SELECT isnull(clientnetaddress,[host_name])Machine,[database_name],[login_name],s.[session_id],
CASE WHEN elapsed_time < 0 THEN RIGHT ( REPLICATE(''0'', max_elapsed_length) + 
	CONVERT(VARCHAR, (-1 * elapsed_time) / 86400), max_elapsed_length ) + RIGHT ( CONVERT(VARCHAR, 
	DATEADD(second, (-1 * elapsed_time), 0), 120), 9 ) + ''.000'' ELSE RIGHT ( REPLICATE(''0'', max_elapsed_length) + 
	CONVERT(VARCHAR, elapsed_time / 86400000), max_elapsed_length ) + RIGHT ( CONVERT(VARCHAR, 
	DATEADD(second, elapsed_time / 1000, 0), 120), 9 ) + ''.'' + RIGHT(''000'' + CONVERT(VARCHAR, elapsed_time % 1000), 3) 
	END AS [dd hh:mm:ss.mss],s.[status]
	, CONVERT(VARCHAR,SPACE(MAX(LEN(CONVERT(VARCHAR, CPU))) OVER() - LEN(CONVERT(VARCHAR, CPU))) + LEFT(CONVERT(CHAR(22), 
	CONVERT(MONEY, CPU), 1), 19)) AS CPU
	, CONVERT(VARCHAR,SPACE(MAX(LEN(CONVERT(VARCHAR, tempdb_current))) OVER() - LEN(CONVERT(VARCHAR, tempdb_current))) + 
	LEFT(CONVERT(CHAR(22), CONVERT(MONEY, tempdb_current), 1), 19)) AS tempdb_current

	,CONVERT(VARCHAR, SPACE(MAX(LEN(CONVERT(VARCHAR, used_memory))) OVER() - LEN(CONVERT(VARCHAR, used_memory))) + 
	LEFT(CONVERT(CHAR(22), CONVERT(MONEY, used_memory), 1), 19)) AS used_memory
	,s.[blocking_session_id]
	--,CONVERT(VARCHAR,SPACE(MAX(LEN(CONVERT(VARCHAR, blocked_session_count))) OVER()-LEN(CONVERT(VARCHAR, blocked_session_count))) + 
	 --LEFT(CONVERT(CHAR(22), CONVERT(MONEY, blocked_session_count), 1), 19)) AS blocked_session_count
,[sql_text],[wait_info]--,[program_name]
,[login_time],start_time,
procedurename,
 --CASE WHEN status = N''sleeping'' THEN NULL ELSE request_id END AS [request_id],
 GETDATE() AS [collection_time] 
	--CONVERT(VARCHAR, SPACE(MAX(LEN(CONVERT(VARCHAR, physical_io))) OVER() - LEN(CONVERT(VARCHAR, physical_io))) 
	--+ LEFT(CONVERT(CHAR(22), CONVERT(MONEY, physical_io), 1), 19)) AS physical_io, 

	,CONVERT(VARCHAR, SPACE(MAX(LEN(CONVERT(VARCHAR, reads))) OVER() - LEN(CONVERT(VARCHAR, reads))) + 
	LEFT(CONVERT(CHAR(22), CONVERT(MONEY, reads), 1), 19)) AS reads
	, CONVERT(VARCHAR, 
	SPACE(MAX(LEN(CONVERT(VARCHAR, physical_reads))) OVER() - LEN(CONVERT(VARCHAR, physical_reads))) + 
	LEFT(CONVERT(CHAR(22), CONVERT(MONEY, physical_reads), 1), 19)) AS physical_reads,

	CONVERT(VARCHAR, SPACE(MAX(LEN(CONVERT(VARCHAR, writes))) OVER() - LEN(CONVERT(VARCHAR, writes))) + 
	LEFT(CONVERT(CHAR(22), CONVERT(MONEY, writes), 1), 19)) AS writes
	
	, CONVERT(VARCHAR,SPACE(MAX(LEN(CONVERT(VARCHAR, tempdb_allocations))) OVER() - LEN(CONVERT(VARCHAR, tempdb_allocations))) + 
	LEFT(CONVERT(CHAR(22), CONVERT(MONEY, tempdb_allocations), 1), 19)) AS tempdb_allocations

	--, CONVERT(VARCHAR, SPACE(MAX(LEN(CONVERT(VARCHAR, context_switches))) 
	--OVER() - LEN(CONVERT(VARCHAR, context_switches))) +LEFT(CONVERT(CHAR(22), CONVERT(MONEY, context_switches), 1), 19)) AS context_switches
	--, CONVERT(VARCHAR,SPACE(MAX(LEN(CONVERT(VARCHAR, tasks))) OVER() - LEN(CONVERT(VARCHAR, tasks))) + LEFT(CONVERT(CHAR(22), 
	--CONVERT(MONEY, tasks), 1), 19)) AS tasks
	--, LEFT(tran_log_writes 	,LEN(tran_log_writes) - 1) AS tran_log_writes
	--, CONVERT(VARCHAR, SPACE(MAX(LEN(CONVERT(VARCHAR, open_tran_count))) OVER() - 
	--LEN(CONVERT(VARCHAR, open_tran_count))) + LEFT(CONVERT(CHAR(22), CONVERT(MONEY, open_tran_count), 1), 19))
	-- AS open_tran_count
	 --, CONVERT(VARCHAR,
	 -- SPACE(MAX(LEN(CONVERT(VARCHAR, CONVERT(MONEY, percent_complete), 2))) OVER() - LEN(CONVERT(VARCHAR, 
	 -- CONVERT(MONEY, percent_complete), 2))) + CONVERT(CHAR(22), CONVERT(MONEY, percent_complete), 2)) AS percent_complete 
	 --,c.*
FROM #TMP_SESSIONS_KAR s 
left join (SELECT session_id
	  ,CASE MAX ( LEN ( CONVERT ( VARCHAR, CASE WHEN elapsed_time < 0 THEN (-1 * elapsed_time)
			/ 86400 ELSE elapsed_time / 86400000 END ) ) ) OVER () WHEN 1 THEN 2 ELSE MAX ( LEN ( CONVERT ( VARCHAR, 
			CASE WHEN elapsed_time < 0 THEN (-1 * elapsed_time) / 86400 ELSE elapsed_time / 86400000 END ) ) ) OVER () 
			END AS max_elapsed_length 
FROM #TMP_SESSIONS_KAR AS s1 
			WHERE s1.recursion = 1

			) b on s.session_id=b.session_id
left join (
select distinct 
req.session_id as session_id,
sys.blocked as blocking_session_id,
...
,CONVERT(NUMERIC(6, 2), req.percent_complete) AS [% Complete]
    ,CONVERT(VARCHAR(20), DATEADD(ms, req.estimated_completion_time, GetDate()), 20) AS [Estimated Completion Time]
    ,CONVERT(NUMERIC(32, 2), req.total_elapsed_time / 1000.0 / 60.0) AS [Elapsed Min]
    ,CONVERT(NUMERIC(32, 2), req.estimated_completion_time / 1000.0 / 60.0) AS [Estimated Min]
    ,CONVERT(NUMERIC(32, 2), req.estimated_completion_time / 1000.0 / 60.0 / 60.0) AS [Estimated Hours]

from sys.dm_exec_requests req
cross apply sys.dm_exec_sql_text(sql_handle) as sqltext
left join sys.dm_exec_query_stats c on req.query_plan_hash=c.query_plan_hash
...
inner join sys.sysprocesses sys on req.session_id=sys.spid
--order by req.cpu_time desc
) c on c.session_id=b.session_id

			where s.recursion = 1

			) B ON A.PROC_NAME=B.procedurename
...
--WHERE STARTTIME IS NULL)
		WHERE STEPNO =(SELECT MIN(STEPNO) FROM ##tmp_kar_job_status_F WHERE STARTTIME IS NULL)

			)B ON A.STEPNAME=B.STEPNAME
LEFT JOIN ( 
select DISTINCT job.name AS JOB_NAME
,activity.run_requested_date AS RUN_DATE
,STUFF(CONVERT(VARCHAR(20),GETDATE()-activity.run_requested_date,114),1,2
,DATEDIFF(hh,0,GETDATE()-activity.run_requested_date)) Duration   
,CASE WHEN activity.last_executed_step_id is null THEN ''Step 1 executing'' ELSE ''Step '' + 
convert(VARCHAR(20), last_executed_step_id + 1) + '' executing'' END AS JOB_STEP
from msdb.dbo.sysjobactivity activity
left join msdb.dbo.sysjobs_view job on activity.job_id=job.job_id
...
)C ON A.JOB_NAME=C.JOB_NAME AND B.procedurename IS NOT NULL
...
FROM (select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS''PROC_NAME,''1'' STEP_ID,''1'' STEP_SUBID,''Daily_MB_Table_Created'' STEPNAME
UNION ALL select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS''PROC_NAME,''1'' STEP_ID,''2'' STEP_SUBID,''Daily_MB_Loan_Cycle_Updated''
UNION ALL select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS''PROC_NAME,''1'' STEP_ID,''3'' STEP_SUBID,''Daily_MB_Cashless_Table_Created''
UNION ALL select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS''PROC_NAME,''1'' STEP_ID,''4'' STEP_SUBID,''Daily_Credit_MB_Repayment_Summary_Started''
UNION ALL select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS''PROC_NAME,''1'' STEP_ID,''5'' STEP_SUBID,''Daily_Credit_MB_Repayment_Summary_Created''
UNION ALL select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS''PROC_NAME,''1'' STEP_ID,''6'' STEP_SUBID,''Daily_Credit_MB_Repayment_Completed''
UNION ALL select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS''PROC_NAME,''1'' STEP_ID,''7'' STEP_SUBID,''Credit_Repayment_Table_Copied''
UNION ALL select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS''PROC_NAME,''1'' STEP_ID,''8'' STEP_SUBID,''Credit_Repayment_Table_Creation_Completed''
UNION ALL select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS_Updates''PROC_NAME,''2'' STEP_ID,''1'' STEP_SUBID,''Credit_Repayment_Table_Updates_1_Start''
UNION ALL select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS_Updates''PROC_NAME,''2'' STEP_ID,''2'' STEP_SUBID,''Credit_Repayment_Table_Updates_1_End''
UNION ALL select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS_Updates''PROC_NAME,''2'' STEP_ID,''3'' STEP_SUBID,''Credit_Repayment_Table_Updates_2_Start''
UNION ALL select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS_Updates''PROC_NAME,''2'' STEP_ID,''4'' STEP_SUBID,''Credit_Repayment_Table_Updates_2_End''
UNION ALL select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS_Updates''PROC_NAME,''2'' STEP_ID,''5'' STEP_SUBID,''Credit_Repayment_Table_Updates_3_Start''
UNION ALL select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS_Updates''PROC_NAME,''2'' STEP_ID,''6'' STEP_SUBID,''Credit_Repayment_Table_Updates_3_End''
UNION ALL select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS_Updates''PROC_NAME,''2'' STEP_ID,''7'' STEP_SUBID,''Credit_Repayment_Table_Updates_4_Start''
UNION ALL select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS_Updates''PROC_NAME,''2'' STEP_ID,''8'' STEP_SUBID,''Credit_Repayment_Table_Updates_4_End''
UNION ALL select ''DSS_Credit_Due_Vs_Col''JOB_NAME,''r_UJJ_Credit_MB_Repayment_Data_MIS_Updates''PROC_NAME,''2'' STEP_ID,''9'' STEP_SUBID,''Hourly_Credit_Repayment_Table_Created''
 )A
